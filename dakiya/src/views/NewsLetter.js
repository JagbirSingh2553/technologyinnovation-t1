...
async function handleSubmit(event) {
  ...
  try {
    ...
    const storeResponse = await fetch("https://dakiya-backend.onrender.com:3001/api/store", {
      method: "POST",
      headers: {
    ...
    if (storeResponse.ok) {
      ...
      const emailResponse = await fetch("https://dakiya-backend.onrender.com:3001/api/subscribe", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
